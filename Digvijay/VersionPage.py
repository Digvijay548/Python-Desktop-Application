...
class Versionpage(tk.CTkFrame):
    def __init__(self, master,heights,widths):     
        ...
        self.headinglabel = tk.CTkLabel(self.centerframe, text="Versionpage Settings",text_color="white",height=20,width=80,font=("Arial", 16))
